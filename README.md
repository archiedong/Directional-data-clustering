...
# Conclusion
CKMM for describing elliptical directional data in the presence of scatter or outliers on a sphere is proposed. It provides a modeling improvement to the exisiting model-based clustering approaches in the framework of directional data. In a series of experiments on simulated data, CKMM demonstrates strong modeling and clustering performance. The application of the method to the Rock Site data produces the best fit and good clustering result.
